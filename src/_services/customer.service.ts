...
export class CustomerService{
  ...
  public findCustomer():Promise<Array<Customer>>{
    return new Promise((resolve,reject)=>{
      resolve([new Customer({id:1,fdName:'张馨文',fdTel:'13973105080',fdCompanyName:'',fdCompanyAddr:'',fdBirthday:'',fdHomeAddr:'',fdCompanyContact:'',fdConsumeLevel:'100-300',fdCar:'银色大众792',fdBuyPurpose:'分销销售',fdType:'渠道',fdRemark:'比较直爽，也比较精明。'}),
        ...
        new Customer({id:3,fdName:'刘建忠',fdTel:'',fdCompanyName:'湖南华韵成套设备有限公司',fdCompanyAddr:'长沙大道附近',fdBirthday:'',fdHomeAddr:'',fdCompanyContact:'',fdConsumeLevel:'300-500以上',fdCar:'宝马JOZ99',fdBuyPurpose:'餐中客户',fdType:'团购',fdRemark:'45左右，171 cm左右，陕西汉中人，做医疗设备，主要请红爹喜欢吃牛肉，老面馒头希望餐标不要太高。'}),
